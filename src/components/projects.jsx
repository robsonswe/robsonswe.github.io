...
function Projects() {
  ...
  const projectsList = fireProjects.map((item) => {
    ...
    if (item.screenshot) {
      return (
        <div key={item.id} >
          <div className="flex flex-row justify-between bg-lightgblue mb-2 rounded w-full gap-5 text-left p-3" >
          ...
          <div className="flex flex-row text-sm justify-center p-1 w-fit bg-lightgblue mb-1 rounded border border-midgray">
            <Link href="./projects/dummy" className="hover:underline underline-offset-2 border-r px-2 border-midgray">Details</Link>
            <Link href={item.preview} target='_blank' className="hover:underline underline-offset-2 px-2 border-midgray">Live Version</Link>
            <Link href={item.preview} target='_blank' className="hover:underline underline-offset-2 border-l px-2 border-midgray">Source Code</Link>
          </div>
        </div>
      );
    }
  ...
  return (
    <section id="projects" className="ml-2 flex flex-col">
      ...
      <div className="flex flex-row text-sm justify-center p-1 w-fit bg-lightgblue mb-1 rounded border border-midgray self-center">
        <div>
