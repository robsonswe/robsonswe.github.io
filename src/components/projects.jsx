    ...
    <section id="projects" className="mb-20">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        {sortedProjects.map((project) => (
          ...
          >
            <h3 className="mb-2 text-2xl transition-colors font-terminal text-terminal-highlight group-hover:text-terminal-accent">
      ...
      <div className="flex justify-center gap-4 mt-8">
        <Link
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 px-4 py-2 text-lg font-bold transition-all duration-300 border rounded-md border-terminal-accent/20 text-terminal-accent hover:text-terminal-highlight hover:bg-terminal-muted/20"
        >
          <ExternalLink size={16} />
